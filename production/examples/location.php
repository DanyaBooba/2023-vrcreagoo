...
<body>
    ...
    <a-scene room-manager="nav: true; startPos: 0 0 -40">
        ...
        <a-assets>
            <a-asset-item id="getcityexample" src="/models/stand/road.glb"></a-asset-item>
        </a-assets>
        <a-entity gltf-model="#getcityexample" modify-materials></a-entity>

        <a-entity id="ocean" position="0 -5 0" scale="3 3 3" ocean="density: 20; width: 50; depth: 50; speed: 4" material="color: #9CE3F9; opacity: 0.75; metalness: 0; roughness: 1" rotation="-90 0 0"></a-entity>
        <a-entity id="sky" geometry="primitive: sphere; radius: 5000" material="shader: gradient; topColor: 235 235 245; bottomColor: 185 185 210" scale="-1 1 1"></a-entity>
        <a-entity id="light" light="type: ambient; color: #eee"></a-entity>

        <a-entity id="name" position="-3.833 -1.8 -2.570" rotation="0 30 0" scale="1 1 1" gltf-model="/models/name.glb"></a-entity>

        <a-entity id="stands1" position="0 -2 0" scale="1 1 1" gltf-model="/models/stand/road.glb"></a-entity>
